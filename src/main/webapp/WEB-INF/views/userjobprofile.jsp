				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="/jobboard/userprofile/${seeker.jobseekerId}">Profile</a></li>
	...
	<div class="bod" style="margin-top: 5px">
		...
		<header id="stp-header">
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
					<c:if test="${applied == 0 && job.state != 3}">
						...
						<c:if test="${applied == 1}">
							...
							<button class="btn btn-lg btn-block btn-warning"
								onclick="">APPLICATIONS DUE</button>
						</c:if>
				...
				<div id="id01" class="modal">
					...
					<form class="modal-content animate" action="/jobboard/application/apply" method="post" enctype="multipart/form-data">
						<div class="container-fluid">
							<div class="col-sm-6 dropdown form-group">
									<div>
											...
											type="radio" name="resumeFlag" value="1" checked="checked"
											autocomplete="off" />
    										<label>Qualifications document</label> <input type="file" name="file" /><br/><br/>
