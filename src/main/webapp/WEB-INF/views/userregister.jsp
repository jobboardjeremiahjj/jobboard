                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 dropdown form-group">
                                        <div>
                                            <label>Highest education</label> <label
                                                class="btn btn-default"><input type="radio"
                                                                           name="highesteducation" id="seeker" value="1"
                                                                           autocomplete="off"
                                            ...
                                            <label class="btn btn-default"> <input
                                                    type="radio" name="highesteducation" id="recruiter" value="0"
                                        ...
                                        <label>Class</label> <input type="text"
                                                                    name="edClass" placeholder="Enter class of your highest education"
