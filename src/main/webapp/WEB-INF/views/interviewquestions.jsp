    ...
    <body id="pagetop">
        ...
        <div class="container-fluid">
            ...
            <div id="id01" class="modal">
                ...
                <form class="modal-content animate" action="/jobboard/question/add" method="post">
                    <div class="container-fluid">
                        <div class="col-sm-8 dropdown form-group">
                            <div>
                                <br/>
                                ...
                                <input type="text" placeholder='optionA/optionB/optionC' name="answer" /><br/><br/>
                            </div>
            ...
            <div class="results">
                <h2>ALL QUESTIONS</h2>
                <p>${fn:length(questions)} results</p>

                <div class="col-lg-5 col-md-5 col-sm-5">
                <input type="submit"
                       class="btn btn-lg btn-block btn-success" onclick="document.getElementById('id01').style.display = 'block'"
                       value="Add" />
                </div>
                    ...
                    <tbody>
                        ...
                        <tr >
                            ...
                            <td><a onclick="return confirm('Are you sure you want to delete this!!!!')"
                                   class="btn btn-danger">Delete</a></h2></td>
