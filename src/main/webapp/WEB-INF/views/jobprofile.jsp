...
h1, h1 a, a, h3, h3 a, h4, h4 a, h5, h5 a, h6, h6 a {
...
<body id="pagetop" class="container-fluid well">
	...
	<header id="stp-header">
		...
		<div class="row " style="margin: auto">
					<form class="" action="/jobboard/company/showapplicants" method="get">
						<input type="hidden" name="jobId" value="${job.jobId}"></input>

						<button type="submit" class="btn btn-block btn-primary">VIEW ALL APPLICANTS FOR THIS JOB</button>
					</form>
			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12 stp-user-bio">
					...
					<h3>${job.location}</h3>
                                        <br>
                                        <h3>Applications Due on: ${job.due}</h3>
					<br>
					<h3>
						Status:
					...
					<!-- job info -->
                            ...
                            <div class="col-sm-4">
				<form action="/jobboard/JobPosting/update/${job.jobId}" method="get">
