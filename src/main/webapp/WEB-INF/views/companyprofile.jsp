                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-8 col-xs-12 stp-user-bio">
                            <h1>BINDURA UNIVERSITY OF SCIENCE EDUCATION</h1>
                        ...
                        <div
                            ...
                            <br>
                            <form action="/jobboard/JobPosting" method="get">
                                ...
                                <br>
                            <form action="/jobboard/question/get" method="get">
                                <button type="submit" class="btn btn-block btn-primary">Interview Questions
                                </button>
                            </form>
            ...
            <section id="stp-content-area">
                <div class="container">
                    ...
                    <div class="row " style="margin: auto">
                        <form class="" action="/jobboard/company/getjobs" method="get">
                            <input type="hidden" name="companyId" value="${company.companyId}"></input>

                            <button type="submit" class="btn btn-block btn-primary">CURRENT BUSE VACANCIES</button>
                        </form>
