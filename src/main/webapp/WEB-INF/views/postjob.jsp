...
<body id="pagetop">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="#pagetop">BUSE Recruitment</a>
				</div>
				<ul class="nav navbar-nav navbar-right">

					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">logged in as BUSE }
	...
	<div class="container">
			...
			<div class="col-lg-12 well">
				<div class="row">
					<form action="/jobboard/JobPosting" method="post">
						...
						<div class="col-sm-12">
							...
							<div class="form-group">
                                                            <label>Responsibilities *</label> <textarea type="text" rows="3"
									placeholder="Enter Responsibilities Here.." class="form-control"
                                                                        name="responsibilities" required></textarea>
							</div>
							
							<div class="form-group">
								<label>Description</label>
								<textarea placeholder="Enter Description Here.." rows="2"
							...
							<div class="form-group">
								...
								<label><b>Applications due date</b></label> <input type="datetime-local"
									lass="form-control" name="due"
									required>
							</div>
